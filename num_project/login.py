...
def login():
    ...
    window.geometry('200x200+500+500')
    ...
    entry_email.place(x=60, y=50, width=100, height=30)

    # 密码输入
    tkinter.Label(text='管理员密码').place(x=0, y=80, width=60, height=40)
    entry_pwd = tkinter.Entry(show='*')
    entry_pwd.place(x=60, y=90, width=100, height=30)
    ...
    tkinter.Button(text='取消', command=sys.exit).place(x=130, y=160, width=55, height=30)
